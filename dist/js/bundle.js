...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar talents = exports.talents = fetch(\"https://us.api.blizzard.com/wow/character/zul'jin/meerkatz?fields=talents&locale=en_US&access_token=USSFMEsUhuGktbv7T2Yr3c9RSU6UTgBZ8z\").then(function (response) {\n  return response.json();\n}).then(function (data) {\n  var output = document.getElementById('wow');\n  var talentsSection = document.createElement('section');\n  var talentsDiv = document.createElement('section');\n  var talentsHeading = document.createElement('h1');\n  talentsHeading.innerHTML = 'Talents:';\n  talentsDiv.classList.add('output-talentHeading');\n  talentsSection.classList.add('output-talents');\n  var talentList = document.createElement('ul');\n  talentList.classList.add('output-talentList');\n  var talentTest = data.talents[0].talents.map(function (talent) {\n    return '\\n      <li>\\n        <img\\n          src=\"https://render-us.worldofwarcraft.com/icons/56/' + talent.spell.icon + '.jpg\"\\n          alt=\"' + talent.spell.description + '\"\\n        >\\n        -\\n          ' + talent.spell.name + '\\n      </li>\\n      ';\n  });\n  talentList.innerHTML = talentTest.join(\" \");\n  talentsSection.appendChild(talentList);\n  talentsDiv.appendChild(talentsHeading);\n  output.appendChild(talentsDiv);\n  output.appendChild(talentsSection);\n});\n\n//# sourceURL=webpack:///./src/js/talents.js?");

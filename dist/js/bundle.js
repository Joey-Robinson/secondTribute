...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.ffCall = undefined;\n\nvar _finalFantasyProfessions = __webpack_require__(/*! ../user/finalFantasyProfessions */ \"./src/js/user/finalFantasyProfessions.js\");\n\nvar _finalFantasyJobs = __webpack_require__(/*! ../user/finalFantasyJobs */ \"./src/js/user/finalFantasyJobs.js\");\n\nvar _finalFantasyMounts = __webpack_require__(/*! ../user/finalFantasyMounts */ \"./src/js/user/finalFantasyMounts.js\");\n\nvar _finalFantasyMinions = __webpack_require__(/*! ../user/finalFantasyMinions */ \"./src/js/user/finalFantasyMinions.js\");\n\nvar _ffResources = __webpack_require__(/*! ../user/ffResources */ \"./src/js/user/ffResources.js\");\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar ffCall = exports.ffCall = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var response, data, resourcesTwo, primary, ffProfessions, ffProfessionsTwo, ffMounts, ffMinions, name, birthday, server, portrait, moogles, miqote, armory, freeCompany, jobs, professions, mounts, minions, professionImage, combatImage, mountImage, minionImage;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return fetch(\"https://xivapi.com/Character/10803092?key=e6a0198acbbf45bda79ab685\");\n\n          case 2:\n            response = _context.sent;\n            _context.next = 5;\n            return response.json();\n\n          case 5:\n            data = _context.sent;\n            resourcesTwo = document.querySelector('.finalfantasy-activities__two');\n            primary = document.querySelector('.finalfantasy-primary');\n            ffProfessions = document.querySelector('.finalfantasy-professions__one');\n            ffProfessionsTwo = document.querySelector('.finalfantasy-professions__two');\n            ffMounts = document.querySelector('.finalfantasy-professions__three');\n            ffMinions = document.querySelector('.finalfantasy-professions__four');\n            name = data.Character.Name;\n            birthday = data.Character.Nameday;\n            server = data.Character.Server;\n            portrait = data.Character.Portrait;\n            moogles = \"http://finalfantasy.wikia.com/wiki/Moogle_(race)\";\n            miqote = \"http://finalfantasy.wikia.com/wiki/Miqo%27te\";\n            armory = \"https://na.finalfantasyxiv.com/lodestone/character/10803092/\";\n            freeCompany = \"https://na.finalfantasyxiv.com/lodestone/freecompany/9234490298434948752/\";\n            jobs = _finalFantasyJobs.finalFantasyJobs;\n            professions = _finalFantasyProfessions.finalFantasyProfessions;\n            mounts = _finalFantasyMounts.finalFantasyMounts;\n            minions = _finalFantasyMinions.finalFantasyMinions;\n\n            for (professionImage in professions) {\n              ffProfessions.innerHTML += '<img src=\"' + professions[professionImage] + '\" alt=\"Profession Job ' + professionImage + '\"/>';\n            }\n            for (combatImage in jobs) {\n              ffProfessionsTwo.innerHTML += '<img src=\"' + jobs[combatImage] + '\" alt=\"Combat Job ' + combatImage + '\" />';\n            }\n            for (mountImage in mounts) {\n              ffMounts.innerHTML += '<img src=' + mounts[mountImage] + ' alt=\"Favorite Mount ' + mountImage + '\" />';\n            }\n            for (minionImage in minions) {\n              ffMinions.innerHTML += '<img src=' + minions[minionImage] + ' alt=\"Favorite Minion ' + minionImage + '\" />';\n            }\n            resourcesTwo.innerHTML = _ffResources.ffResourcesList.join(\" \");\n            primary.innerHTML = '\\n  <h1>A Bit About Me:</h1>\\n    <h3>Name: \\n      <a\\n        href=' + armory + '\\n        target=\"_blank\"\\n        rel=\"noopener noreferrer\"\\n      >\\n        ' + name + '\\n      </a>\\n    </h3>\\n    <h3>Birthday: ' + birthday + '</h3>\\n    <h3>Server: ' + server + '</h3>\\n    <h3>Free Company: \\n      <a\\n        href=' + freeCompany + '\\n        target=\"_blank\"\\n        rel=\"noopener noreferrer\"\\n      >\\n        The Last Homely House\\n      </a>\\n    </h3>\\n    <h3>Favorite NPC Race: \\n      <a\\n        href=' + moogles + '\\n        target=\"_blank\"\\n        rel=\"noopener noreferrer\"\\n      >\\n        Moogles!\\n      </a>\\n    </h3>\\n    <h3>Favorite Playable Race:\\n      <a\\n        href=' + miqote + '\\n        target=\"_blank\"\\n        rel=\"noopener noreferrer\"\\n      >\\n        Female Miq\\'ote\\n      </a>\\n    </h3>\\n    <h3>Current Look:\\n      <br />\\n      <a\\n        href=' + portrait + '\\n        target=\"_blank\"\\n        rel=\"noopener noreferrer\"\\n      >\\n        <img src=\"' + portrait + '\" />\\n      </a>\\n    </h3>\\n  ';\n\n          case 30:\n          case 'end':\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined);\n  }));\n\n  return function ffCall() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nffCall();\n\n//# sourceURL=webpack:///./src/js/api/finalFantasy.js?");

/***/ }),

/***/ "./src/js/api/meerkats.js":
/*!********************************!*\
  !*** ./src/js/api/meerkats.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar ristretta = exports.ristretta = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var response, data, wow, wowBest, recent, profile, name, spec, druid, recentPlus, plusRankRealm, bestOverall, druidInformation, recentInner, wowBestInner;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return fetch(\"https://raider.io/api/v1/characters/profile?region=us&realm=Zul'jin&name=Ristretta&fields=gear,mythic_plus_scores,mythic_plus_ranks,mythic_plus_recent_runs,mythic_plus_best_runs\");\n\n          case 2:\n            response = _context.sent;\n            _context.next = 5;\n            return response.json();\n\n          case 5:\n            data = _context.sent;\n            wow = document.querySelector(\".wow-ristretta\");\n            wowBest = document.querySelector(\".wow-ristrettaBest\");\n            recent = document.querySelector(\".wow-ristrettaRecent\");\n            profile = data.profile_url;\n            name = data.name;\n            spec = data.active_spec_name;\n            druid = data.class;\n            recentPlus = data.mythic_plus_recent_runs;\n            plusRankRealm = data.mythic_plus_ranks.class_healer.realm;\n            bestOverall = data.mythic_plus_best_runs;\n            druidInformation = 'https://wow.gamepedia.com/Monk';\n            recentInner = recentPlus.map(function (dungeon) {\n              return \"\\n      <table>\\n        <tr>\\n          <td>\\n            <a\\n              href=\" + dungeon.url + \"\\n              target=\\\"_blank\\\"\\n              rel=\\\"noopener noreferrer\\\"\\n            >\\n              + \" + dungeon.num_keystone_upgrades + \"\\n              \" + dungeon.dungeon + \" &hybull;\\n              \" + dungeon.mythic_level + \"\\n            </a>\\n          </td>\\n        </tr>\\n      </table>\\n    \";\n            });\n            wowBestInner = bestOverall.map(function (best) {\n              return \"\\n    <table>\\n      <tr>\\n        <td>\\n          <a \\n            href=\" + best.url + \"\\n            target=\\\"_blank\\\"\\n            rel=\\\"noopener noreferrer\\\"\\n          >\\n          \" + best.mythic_level + \" - \\n          \" + best.dungeon + \"\\n          </a>\\n        </td>\\n      </tr>\\n    </table>\\n  \";\n            });\n\n\n            wow.innerHTML = \"\\n    <h4>Monk Information</h4>\\n      <table>\\n        <tr>\\n          <td>Name: <a target=\\\"_blank\\\" rel=\\\"noreferrer noopener\\\" href=\" + profile + \">\" + name + \"</a></td>\\n        </tr>\\n        <tr>\\n          <td>Spec | Class: <a target=\\\"_blank\\\" rel=\\\"noreferrer noopener\\\" href=\" + druidInformation + \"> \" + spec + \" \" + druid + \"</a></td>\\n        </tr>\\n        <tr>\\n          <td>Current Realm Rank: \" + plusRankRealm + \"</td>\\n        </tr>\\n      </table>\\n  \";\n\n            recent.innerHTML = \"<h4>Recent Mythic Plus Runs</h4>\" + recentInner.join(\" \");\n            wowBest.innerHTML = \"<h4>Best Mythic Plus Runs</h4>\" + wowBestInner.join(\" \");\n\n          case 22:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined);\n  }));\n\n  return function ristretta() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nristretta();\n\n//# sourceURL=webpack:///./src/js/api/ristretta.js?");
...
/***/ "./src/js/user/finalFantasyMinions.js":
/*!********************************************!*\
  !*** ./src/js/user/finalFantasyMinions.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar finalFantasyMinions = exports.finalFantasyMinions = {\n  bom_boko: '../../src/images/bom_boko.png',\n  brina: '../../src/images/brina.png',\n  calca: '../../src/images/calca.png',\n  coeurl_kitten: '../../src/images/coeurl_kitten.png',\n  fat_cat: '../../src/images/fat_cat.png',\n  heavy_hatchling: '../../src/images/heavy_hatchling.png',\n  koala_joey: '../../src/images/koala_joey.png',\n  odder_otter: '../../src/images/odder_otter.png',\n  unicolt: '../../src/images/unicolt.png',\n  wind_up_alisaie: '../../src/images/wind-up_alisaie.png',\n  wind_up_alphinaud: '../../src/images/wind-up_alphinaud.png',\n  wind_up_namazu: '../../src/images/wind-up_namazu.png',\n  wind_up_raubahn: '../../src/images/wind-up_raubahn.png',\n  dress_up_thancred: '../../src/images/dress-up_thancred.png',\n  gaelikitten: '../../src/images/gaelikitten.png'\n};\n\n//# sourceURL=webpack:///./src/js/user/finalFantasyMinions.js?");

/***/ }),

/***/ "./src/js/user/finalFantasyMounts.js":
/*!*******************************************!*\
  !*** ./src/js/user/finalFantasyMounts.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar finalFantasyMounts = exports.finalFantasyMounts = {\n  behemoth: '../../src/images/behemoth.png',\n  blissful_kamuy: '../../src/images/blissful_kamuy.png',\n  cloud_mallow: '../../src/images/cloud_mallow.png',\n  dark_lanner: '../../src/images/dark_lanner.png',\n  demonic_lanner: '../../src/images/demonic_lanner.png',\n  fat_chocobo: '../../src/images/fat_chocobo.png',\n  ixion: '../../src/images/ixion.png',\n  mikoshi: '../../src/images/mikoshi.png',\n  mychocobo: '../../src/images/mychocobo.png',\n  original_fat_chocobo: '../../src/images/original_fat_chocobo.png',\n  rose_lanner: '../../src/images/rose_lanner.png',\n  sophic_lanner: '../../src/images/sophic_lanner.png',\n  twintania: '../../src/images/twintania.png',\n  tyrannosaur: '../../src/images/tyrannosaur.png',\n  zu: '../../src/images/zu.png'\n};\n\n//# sourceURL=webpack:///./src/js/user/finalFantasyMounts.js?");

/***/ }),

/***/ "./src/js/user/finalFantasyProfessions.js":
/*!************************************************!*\
  !*** ./src/js/user/finalFantasyProfessions.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar finalFantasyProfessions = exports.finalFantasyProfessions = {\n  alchemist: '../../src/images/alchemist.png',\n  armorer: '../../src/images/armorer.png',\n  blacksmith: '../../src/images/blacksmith.png',\n  carpenter: '../../src/images/carpenter.png',\n  culinarian: '../../src/images/culinarian.png',\n  goldsmith: '../../src/images/goldsmith.png',\n  leatherworking: '../../src/images/leatherworking.png',\n  weaver: '../../src/images/weaver.png',\n  botanist: '../../src/images/botanist.png',\n  fishing: '../../src/images/fishing.png',\n  mining: '../../src/images/mining.png'\n};\n\n//# sourceURL=webpack:///./src/js/user/finalFantasyProfessions.js?");

/***/ }),

/***/ "./src/js/user/streamers.js":
/*!**********************************!*\
  !*** ./src/js/user/streamers.js ***!
  \**********************************/
/*! no static exports found */
